...
@section('content')
    <section class="jumbotron text-center">
        <h1 class="mt-1 display-4">Fila Akbar Anis Ani Mahmudah</h1>
        <img src="{{asset('project/img/saya.jpg')}}" alt="Fila Akbar" width="200" class="rounded-circle img-thumbnail">
        <p class="lead font-weight-bold display-6">STUDENT</p><p>Motivation</p>

        <h1> "KIETE KOSHI KIRE'KIRETE"</h1>
        <p> <h2>私とあなたは友達です</h2><br><h3>'Fanton Seijin'</h3></p>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('project/img/projects/1.jpg')}}" class="card-img-top" alt="projects 1">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text text-center">Power Ten Ring</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('project/img/projects/2.jpg')}}" class="card-img-top" alt="projects 2">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text text-center">Power Ten Ring</p>
                            </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('project/img/projects/3.jpg')}}" class="card-img-top" alt="projects 3">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text text-center">Power Ten Ring</p>
                            </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('project/img/projects/4.jpg')}}" class="card-img-top" alt="projects 4">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text text-center">Power Ten Ring</p>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form>
                        ...
                        <button type="submit" class="btn btn-primary btn-danger text-white">Kirim</button>
                    </form>
                </div>
            </div>
        </div>
