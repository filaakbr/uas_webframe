...
@section('content')
    <section class="jumbotron text-center">
        <h1 class="mt-1 display-4">NAMA DOSEN</h1>
        <img src="{{asset('project/img/dosen.jpg')}}" alt="Fila Akbar" width="200" class="rounded-circle img-thumbnail">
        <p class="lead font-weight-bold display-6">Dosen</p><p>Motivation</p>

        <h1> "Sukses Selalu Datang Kepada Orang Yang Mencari"</h1>
